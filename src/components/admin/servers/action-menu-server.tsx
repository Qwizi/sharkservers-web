...
export default function ActionMenuServer({...props}: ServerOut) {
    ...
    return (
        <>
            <DeleteServerAlert {...props} isDeleteModalOpen={isDeleteModalOpen} setIsDeleteModalOpen={setIsDeleteModalOpen} />
            <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => router.push(`/admin/servers/${props.id}/edit`)}>Edytuj</DropdownMenuItem>

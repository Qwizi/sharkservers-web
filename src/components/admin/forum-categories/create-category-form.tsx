...
import { adminCreateForumCategoryAction, adminCreateRoleAction, adminCreateServerAction, adminCreateUserAction } from "@/actions";
...
import { CreateForumCategorySchema, CreateRoleSchema, CreateServerSchema, CreateUserSchema } from "@/schemas";
...
export default function CreateForumCategoryForm() {
    const categoryTypes = [CategoryTypeEnum.PUBLIC, CategoryTypeEnum.PRIVATE, CategoryTypeEnum.APPLICATION]

...
import { CategoryOut, RoleOut, RoleOutWithScopes, ServerOut, UserOutWithEmail } from "sharkservers-sdk"
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => router.push(`/admin/forum-categories/${props.id}/edit`)}>Edytuj</DropdownMenuItem>

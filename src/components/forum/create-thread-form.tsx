...
export default function CreateThreadForm({
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    try {
      ...
      const response = isApplicationCategoryMany(categoryId)
        ? await createApplicationThread(data)
        : await createDefaultThread(data);
      toast({
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Przechodzac dalej oznajmiasz, że zapoznaleś się wymyaganiami w
              sprawie rekrutacji i je akceptujesz!
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button type="submit" onClick={() => setShowDialog(!showDialog)}>
              Potwierdzam
            </Button>
          </DialogFooter>
        </DialogContent>
